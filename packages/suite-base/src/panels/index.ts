...
import aetherionAIThumbnail from "./ThreeDeeRender/thumbnail.png"; // Reuse 3D thumbnail for now
...
export const getBuiltin: (t: TFunction<"panels">) => PanelInfo[] = (t) => [
  ...
  },
  {
    title: "Aetherion AI",
    type: "AetherionAI",
    description: "AI-powered gap analysis, simulation generation, and debugging for autonomous vehicle data",
    thumbnail: aetherionAIThumbnail,
    module: async () => await import("./AetherionAI"),
